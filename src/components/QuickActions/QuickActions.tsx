...
export function QuickActionsContainer() {
  return <div id={QUICK_ACTIONS_ID} className='flex flex-col items-end gap-2 p-4'></div>
}

export function QuickAction({ children }: React.PropsWithChildren) {
  const [quickActionsContainer, setquickActionsContainer] = React.useState<Element>()
